...
export function Button({
  ...
  const variantStyles = {
    primary:
      "bg-[#B49BC4] text-white hover:bg-[#8B7A9E] rounded-md px-4 py-3 gap-2",
    secondary: "bg-[#E8DCD3] hover:bg-[#C5B5C9] rounded-md px-4 py-3 gap-2",
    secondary2: "bg-[#8B7A9E] hover:bg-[#B49BC4] rounded-md px-4 py-3 gap-2",
    accent: "bg-[#F4C542] hover:bg-[#F4A460] rounded-md px-4 py-3 gap-2",
    danger:
      "bg-[#F4A460] text-white hover:bg-[#F4C542] rounded-md px-4 py-2 gap-2",
  };
  ...
  return (
    ...
    >
      ...
      <div
        className="font-medium tracking-wider text-[1rem] flex items-center gap-2"
        style={{
          color: variant === "primary" || variant === "accent" || variant === "danger" ? "#ffffff" : "#4A4458",
          fontFamily: "'Space Grotesk', sans-serif",
        }}
      >
        {children}
