...
This document provides Neon-specific configuration, optimization strategies, and operational guidance for the Notely backend.
...
**Example:**
```
postgresql://user123:pass456@ep-notely-123-us-east-2.aws.neon.tech/neondb?sslmode=require
```
