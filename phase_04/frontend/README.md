...
A modern React-based frontend for the Notely todo application, built with Next.js 16+, TypeScript, and Tailwind CSS.
...
This project is part of the Notely Todo Application.
